...
?>
        <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
            <div class="container text-center pt-5 pb-3">
                <h1 class="display-4 text-white animated slideInDown mb-3">Liên hệ với chúng tôi</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <p><i class="fa fa-envelope text-primary me-2"></i> Email: sangntpc08899@gmail.com</p>
                    </div>
