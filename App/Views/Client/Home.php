...
?>
        ...
        <main role="main" class="container d-flex flex-column col-md-12">
            <div class="container col-md-12 d-flex flex-column">
                <!-- Navbar -->
                <div id="header-carousel" class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="https://cdn0.fahasa.com/media/magentothem/banner7/Diamond_1124_AlphaBooks_Resize_Slide_840x320.jpg" alt="Image">
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="https://cdn0.fahasa.com/media/magentothem/banner7/butmau_SlideBanner_840x320.png" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px; height:400px;">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                                <h1 class="display-1 text-white mb-md-4 animated zoomIn">Nhà sách <br> TSBooks</h1>
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="https://cdn0.fahasa.com/media/magentothem/banner7/TrangCTT11_1124_Mainbanner_11.11_840x320_fix.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px; height:400px;">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                                <h1 class="display-1 text-white mb-md-4 animated zoomIn">Nhà sách <br> TSBooks</h1>
                    ...
                    <div class="carousel-item">
                        <img class="w-100" src="https://cdn0.fahasa.com/media/magentothem/banner7/Diamond_1124_AlphaBooks_Resize_Slide_840x320.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px; height:400px;">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                                <h1 class="display-1 text-white mb-md-4 animated zoomIn">Nhà sách <br> TSBooks</h1>
...
<div class="section-sale christmas">
    <h4>Giáng Sinh An Lành</h4> <br> <hr>
    <div class="products-sale">
