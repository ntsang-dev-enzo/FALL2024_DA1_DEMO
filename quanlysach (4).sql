...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 20, 2024 lúc 05:50 PM
...
CREATE TABLE `products` (
  ...
  `cover` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `products` (`id`, `name`, `image`, `description`, `price`, `category_id`, `publisher`, `author`, `supplier`, `cover`, `created_at`, `status`, `discount_price`, `view`) VALUES
(1, 'toán', 'https://cdn0.fahasa.com/media/catalog/product/z/5/z5770767272968_42586e52ffb884fda4be8affeb275ccc.jpg', 'sách', 123312, 1, 'sádasd', 'ádasdas', 'sang', NULL, '2024-11-14 17:08:24', 1, 12332, NULL),
(2, 'sachssadsf', 'https://cdn0.fahasa.com/media/catalog/product/l/e/level-e_3-tap.jpg', 'sdfghj', 123312345, 1, 'wqdfghjk', 'asdfgh', 'sang', NULL, '2024-11-16 00:58:12', 1, 12332, 0);
